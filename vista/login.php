...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link green" href="../controladores/loginController.php" id="navbar">Cuenta admin</a>
                    </li>
    ...
    <div class="container  py-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <center>
                    <h1 class="font-weight-bold cw">Iniciar sesion como administrador</h1>
                </center>
            </div>
        </div>
        ...
        <form action="../controladores/loginController.php" method="POST" class="py-2">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-6">
                    <input required type="password" name="pass" class="form-control" placeholder="Contraseña" size="20">
                </div>
                <div class="col-md-3">
            ...
            <div class="row mt-1">
                ...
                <div class="col-md-2 ml-4">
                    <input id="boton" type="submit" class="cw btn btn-outline-secondary my-2 text-decoration-none" name="ingresar" value="Ingresar">
        ...
        <div class="row">
            ...
            <div class="col-md-7 ml-4">
                <ul class="cw">
                    <li><a href="../controladores/recuperarController.php" class=" cw">¿Olvido su contraseña? Recuperar</a></li>
                </ul>
            </div>
        </div>
