...
<body>
    ...
    <section class="py-6">
        <div class="container my-4">
            <div>
                <h1 class="font-weight-bold cw text-center">Crear servicio</h1>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card inicio px-2" id="estilo1">
                        ...
                        <form action="../controladores/crearServController.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-8">
                                    <input type="text" name="nombreservicio" class="form-control px-2" size="40" placeholder="Servicio" required="yes">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-1"></div>
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-8">
                                    <input type="number" min="0" name="precio" class="form-control px-2" size="40" placeholder="$00.00"step=".01" required="yes">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-1"></div>
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-8">
                                    <textarea required name="descripcion" class="form-control size " placeholder="Descrición del servicio" style="border: none;" wrap="soft"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-1"></div>
                            ...
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <div class="row">
                                        <div class="col-md-1"></div>
                                        <div class="col-md-8">
                                            <div class="form-group font-weight-bold cw mt-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <button id="boton" type="submit" class="cw btn btn-outline-secondary text-decoration-none" name="crear">Crear servicio</button>
                                        </div>
                                    </div>
