...
<body>
    ...
    <section class="py-6">
        <div class="container my-4">
            <div>
                <h1 class="font-weight-bold cw text-center">Modificar noticia</h1>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card inicio px-2" id="estilo1">
                        ...
                        <form action="../controladores/modifNotController.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-8">
                                    <textarea required name="descripcion" class="form-control size" placeholder="Descrición de la noticia" style="border: none;" 
                                    wrap="soft"><?php 
                                    if(!empty($noticia)){
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <select require name="filtro" class="form-control">
                                        ...
                                        <option name="categoria" value="Evento">Eventos</option>
                                        <option name="categoria" value="Promocion">Promociones</option>
                                    </select>
                                </div>
                            </div>
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <input type='hidden' name='idNoticia' value='<?php echo $idNoticia;  ?>' size="0">
                                            <button id="boton" type="submit" class="cw btn btn-outline-secondary text-decoration-none" name="modificar">Modificar noticia</button>
                                        </div>
                                    </div>
