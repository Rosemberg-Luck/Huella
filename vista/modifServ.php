...
<body>
    ...
    <section class="py-6">
        <div class="container my-4">
            <div>
                <h1 class="font-weight-bold cw text-center">Modificar servicio</h1>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card inicio px-2" id="estilo1">
                        ...
                        <form action="../controladores/modifServController.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-5"><label class=" cw font-weight-bold px-2 py-2"> Nombre del servicio:</label></div>
                            </div>
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-8">
                                    <input type="text" name="nombreservicio" class="form-control px-2" size="40" placeholder="Servicio" required="yes" value="<?php
                                                                                                                                                                if (!empty($servicio)) {
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-5"><label class=" cw font-weight-bold px-2 py-2"> Precio del servicio:</label></div>
                            </div>
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-8">
                                    <input type="text" name="precio" class="form-control px-2" size="40" placeholder="$00.00" required="yes" value="<?php
                                                                                                                                                    if (!empty($servicio)) {
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-8">
                                    <textarea required name="descripcion" class="form-control size " placeholder="Descrición del servicio" style="border: none;" wrap="soft"><?php if (!empty($servicio)) {
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-8">
                                    <input type="text" name="rutaArchivo" class="form-control px-2" size="40" placeholder="URL" required value="<?php
                                                                                                                                                if (!empty($servicio)) {
                                                                                                                                                    echo $servicio['rutaArchivo'];
                                                                                                                                                }
                                                                                                                                                ?>">
                                </div>
                            </div>
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group cw">
                                                <label for="exampleFormControlFile1">Imagen de servicio</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <input type='hidden' name='idServicio' value='<?php echo $idServicio;  ?>' size="0">
                                            <button id="boton" type="submit" class="cw btn btn-outline-secondary text-decoration-none" name="modificar">Modificar servicio</button>
                                        </div>
                                    </div>
